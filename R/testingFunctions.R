...
testOutside <- function(data, string="http://co.milesplit.com/meets/<TEST>", sample=20, test=F){
...
testInside <- function(data, col="schoolid", string="http://co.milesplit.com/teams/<TEST>", sample=1, test=F){
  set.seed(1234)
